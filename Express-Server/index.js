...
app.get( '/testJson' ,(req, res) => {
    ...
    res.send(
        ...
        total: 35.36,
        products: [
          { name: 'VINYL GLOVES', price: 11.72, quantity: 1 },
          { name: 'AJAX DISHLIM', price: 2.96, quantity: 1 },
          { name: 'ADVIL DUAL18', price: 3.98, quantity: 1 },
          { name: 'MCC/SCH PARS', price: 2.44, quantity: 1 },
          { name: 'VINYL GLOVES', price: 11.72, quantity: 1 }
        ]
      }
    )
